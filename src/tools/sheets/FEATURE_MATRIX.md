...
- Historical Stage 2 vehicle: draft PR on `feature/tabular-sheet-workstation` (closed history). Current workstream: PR #71 on `feature/tabular-sheet-parity` → `main` only. CoS undrafts and squash-merges; the agent does not merge. Do not expand PX. Do not touch PR #33 / transcode.
...
- Historical Stage 1 vehicle: draft PR on `feature/tabular-sheet-workstation` (closed history). Current workstream: PR #71 on `feature/tabular-sheet-parity` → `main` only. CoS undrafts and squash-merges; the agent does not merge. Do not expand PX. Do not touch PR #33 / transcode.
- Stop product commits after PR #71 is current with this ledger. CoS squash-merge is the remaining vehicle.
