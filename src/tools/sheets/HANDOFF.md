...
**Tip SHA (this revision, pre-browser verification):** see `git rev-parse HEAD` on this branch after push. Replace this line with the pushed SHA once `git push` succeeds.
