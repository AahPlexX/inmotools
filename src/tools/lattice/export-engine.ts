...
export const buildLatticeSvg = (
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="lattice-title" viewBox="0 0 ${layout.bounds.width} ${layout.bounds.height}"><title id="lattice-title">${title}</title><style>.bg{fill:#0b1120}.edge path{fill:none;stroke:#475569;stroke-width:2}.cross path{fill:none;stroke:#38bdf8;stroke-width:1.5;stroke-dasharray:7 5}.node rect{fill:#1e293b;stroke:#475569;stroke-width:1.5}.node text{font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.key{fill:#e2e8f0;font-size:14px;font-weight:700}.value{fill:#cbd5e1;font-size:12px}.type{fill:#38bdf8;font-size:10px}</style><rect class="bg" width="100%" height="100%"/><g id="structural-edges" class="edge">${structuralEdges}</g><g id="foreign-key-links" class="cross">${crossLinks}</g><g id="nodes">${nodes}</g></svg>`;
};
