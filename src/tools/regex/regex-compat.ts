...
export const REGEX_FLAVOR_CATALOG: readonly RegexFlavorDescriptor[] = [
  ...
  { value:'python', label:'Python re · Pyodide', capability:'execution', note:'Executes locally through bundled CPython/Pyodide WebAssembly; Python-specific flags are mapped explicitly.' },
