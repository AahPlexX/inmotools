...
export default function DuckDbWorkspace() {
  ...
  return <>
    ...
    <div className="workspace-body">
      ...
      <div className="field" style={{marginTop:16}}><label htmlFor="sql-query">SQL query</label><textarea id="sql-query" value={query} onChange={(event) => setQuery(event.target.value)} spellCheck={false} /></div>
