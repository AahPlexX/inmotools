...
const TOOL_SPECS = new Map([
  ...
  ['photo', ['tests/e2e/photo.spec.ts', 'tests/e2e/photo-controls.spec.ts', 'tests/e2e/photo-geometry.spec.ts', 'tests/e2e/photo-compare.spec.ts', 'tests/e2e/photo-copy-paste.spec.ts', 'tests/e2e/photo-import.spec.ts', 'tests/e2e/photo-project.spec.ts', 'tests/e2e/photo-merge.spec.ts', 'tests/e2e/photo-workflow.spec.ts']],
