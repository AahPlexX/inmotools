...
**Last tracked implementation commit:** `2979cb0464fe68e50239f052d80268fd1d7e55c6`
...
- G6 remains open. Booleans, extrude/revolve/sweep/loft, offset, fillet/chamfer, and shell are implemented against the real kernel with semantic topology resolution where applicable. Still unimplemented in the evaluator: hole, thicken/draft/split/rib, pattern/mirror/helix/thread/text, datum planes/axes as real placement (currently pass-through only), surfaces, defeaturing, and healing.
