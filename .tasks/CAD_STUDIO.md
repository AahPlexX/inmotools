...
**Last tracked implementation commit:** `13e0a332676a13e72fe26870c06d66d19cbb0d41`
...
- G6 remains open. Booleans, extrude/revolve/sweep/loft, offset, and fillet/chamfer are implemented against the real kernel with semantic topology resolution where applicable. Still unimplemented in the evaluator: hole, shell/thicken/draft/split/rib, pattern/mirror/helix/thread/text, datum planes/axes as real placement (currently pass-through only), surfaces, defeaturing, and healing.
