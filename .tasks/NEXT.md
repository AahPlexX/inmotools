...
- Still open: SVG Sprite Compiler's preview grid renders two images per compiled symbol with no cap. That is a separate display decision (cap, page, or on-demand previews) and is not covered by the table change.
