...
- **Tabular Sheet Workstation (TASK-022)** — PRODUCT CUT APPROVED. Sole writer on `feature/tabular-sheet-parity` P1–P16 (draft PR only; do not merge; do not open a second PR; do not invent extra product scope). Do not shrink Insert Function to XLOOKUP-only.
  ...
  - Tip SHA: `3e87e0a2f0ead527625925f4f0d7b83260e4a4ad` (update this line in the same cycle as any later push). Last focused-gate code: `3e87e0a2f0ead527625925f4f0d7b83260e4a4ad`.
  - Sheets gates at that SHA: focused units 42/42; `pnpm build` pass; desktop-chromium 24 passed; P16 matrix 12/12 (6 portrait + 6 landscape CSS widths); mobile-chromium 11 passed / 13 skipped by design (iPhone 13 is not the P16 gate).
