...
- **Fiber Craft Workstation** — local-first multi-discipline fiber-pattern workstation; crochet is mature and counted-thread Slice 3 is active.
  ...
  - Function progress: **23/65 complete** — FC-02, FC-03, FC-04, FC-07, FC-09–FC-16, FC-35, FC-42, FC-50–FC-52, FC-54–FC-56, FC-59, FC-63, and FC-64. Partial functions are not counted.
  - Current milestone: Slice 2 crochet is complete; Slice 3 counted-thread and Slice 7 publishing are in progress. FC-35 precision counted grid and FC-42 generated floss legend are accepted. FC-36–FC-41 remain open; FC-05/06/08/53 remain shared-infrastructure gaps.
  - Current state: counted-thread supports all 11 full/half/quarter/three-quarter stitch kinds, French knots, backstitch lines, scalable SVG specialty overlays, roving keyboard grid navigation, specialty cleanup, generated symbols, editable floss brand/code identity, accessible chart descriptions, autosave, and validated portable `.craftproj` round-trip without discarding shared project metadata. Crochet publishing/export/offline behavior remains intact.
  - Latest acceptance: run `35170481167` at `cf04ff5b466a7dbb7a0452082e0ee9466f8705bc` passed **58/58** focused checks, production TypeScript/Vite build, 150-entry PWA precache, and **6/6** sequential desktop/mobile Chromium cases. The browser matrix covers crochet/edit/export/recovery, counted-thread edit/key/save/restore including visible knot/backstitch overlays, and offline PWA reload.
  ...
  - Handoff: fetch/reconcile the dedicated branch before editing because concurrent Fiber commits have occurred. `CountedThreadPanel.tsx` is authoritative; do not resurrect deleted `CountedThreadWorkspace.tsx` or `counted-thread-workspace.css`. Never force-push over concurrent work. If local port 4173 belongs to another worktree, leave it alone and use an isolated alternate port for a targeted Fiber run.
