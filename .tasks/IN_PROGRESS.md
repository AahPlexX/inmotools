...
- **Tactical Matchboard Studio** — 60-feature local-first tactical authoring, animation, spatial-analysis, local-video, presentation, persistence, and export workstream on `feature/tactical-matchboard-studio`.
  ...
  - Current milestone: **Task 4 — pitch, rules, formation, and restart authoring.** Task 3 is closed; T04-01 remains the sole ACTIVE forward item and owns its listed tactical engine/workspace/test files. Its remaining work is editable sourced-profile forks, current specialty/grassroots provenance and overlays, restart-specific legality checks, and one vertical-transform assertion.
  - Current verified feature count: **5/60**. Features 9, 10, 11, 12, and 15 are verified; feature 13 is implemented pending focused vertical-transform evidence; features 1, 2, 3, 4, 5, 7, 8, 14, 51, 52, 55, 56, and 59 are in progress; all others remain planned.
  - Current implementation includes the prior beginner board plus versioned/provenance-bearing rules profiles, custom profile/formation/restart authoring, deterministic specialty overlays, arbitrary-size formations, count/assignment review, phase capture/morphing, whole-project mirror/flip actions, and built-in editable restart starters.
  - Current evidence: source commit `a8ee9f46` passes **29/29** focused tactical units, **3/3** selector units, a TypeScript-checked production/PWA build, and **16 browser scenarios** with **2 intentional duplicate-project skips** across desktop/mobile Chromium, including the Task 4 workflow, keyboard activation, Axe, five-width reflow, overflow, and 44px targets.
