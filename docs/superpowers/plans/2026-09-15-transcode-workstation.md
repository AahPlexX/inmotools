...
| M5 | complete 2026-09-15 | F24–F34 implemented: WOFF1 pure-JS codec + WOFF2 wasm + SVG-font→TTF compiler + inline glyph subsetting (F24–F27); ZIP/TAR/TAR.GZ extract+build, bz2/7z/RAR via libarchive.js worker, Base64/hex/data-URI both directions (F28–F30); GeoJSON↔KML/KMZ/GPX/WKT/CSV/SVG-map (F31–F33); PNG tEXt + JPEG EXIF metadata editing at export (F34); 60 focused unit tests green |
